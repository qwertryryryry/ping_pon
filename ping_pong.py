...
class GameSpite(sprite.Sprite):
    def _init_(self, player_img, player_x, player_y, player_speed, width, height):
        super().__init__()
...
lose1 = font.render('1 проиграл', True, (69, 2, 35))
lose1 = font.render('2 проиграл', True, (69, 2, 35))
